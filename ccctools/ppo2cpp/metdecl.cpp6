...
static void walk(ELEM *elem)
{
    ...
    {
        printf("\nclass _method6_%s: public _method6_",sname);
        printf("{public: _method6_%s():_method6_(\"%s\"){};};",sname,sname);
        printf(" static _method6_%s _o_method_%s;",sname,sname);
    }
    else if( pname==0  ) // object:(class)method 
    {
        ...
        printf("\nclass _method6_%s_C_%s: public _method6c_",sname,bname);
        printf("{public: _method6_%s_C_%s():_method6c_(\"%s\",%s){};};",sname,bname,sname,bcall);
        printf(" static _method6_%s_C_%s _o_method_%s_C_%s;",sname,bname,sname,bname);
        free(bcall);
    }
    else if( 0==strcmp(pname,"super") ) // object:(super:class)method  
    {
        ...
        sprintf(clsfun,"%sclass",bname_d);
        char *bcall=fundecl_clpcall(clsfun);
        printf("\nclass _method6_%s_S_%s: public _method6s_",sname,bname);
        printf("{public: _method6_%s_S_%s():_method6s_(\"%s\",%s){};};",sname,bname,sname,bcall);
        printf(" static _method6_%s_S_%s _o_method_%s_S_%s;",sname,bname,sname,bname);
        free(bcall);
    }
    else  // object:(parent:class)method   
    {
        ...
        printf("\nclass _method6_%s_P_%s_C_%s: public _method6p_",sname,pname,bname);
        printf("{public: _method6_%s_P_%s_C_%s():_method6p_(\"%s\",%s,%s){};};",sname,pname,bname,sname,pcall,bcall);
        printf(" static _method6_%s_P_%s_C_%s _o_method_%s_P_%s_C_%s;",sname,pname,bname,sname,pname,bname);
