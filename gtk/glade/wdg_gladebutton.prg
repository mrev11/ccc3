...
****************************************************************************
class gladebutton(gtkbutton,gladewidget) new:
    method initialize

****************************************************************************
static function gladebutton.initialize(this)
...
local ya:=this:widget_hash:get("yalign")
    ...
    if( label==NIL )
        this:gobject:=gtk.button.new()
    elseif( use_stock==NIL )
        this:gobject:=gtk.button.new_with_mnemonic(label)
    else
        this:gobject:=gtk.button.new_from_stock(label)
    end
