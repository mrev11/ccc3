...
****************************************************************************
class gladecheckbutton(gtkcheckbutton,gladewidget) new:
    method initialize

****************************************************************************
static function gladecheckbutton.initialize(this)
...
local focus_on_click:=this:widget_hash:get("focus_on_click")
    ...
    if( label==NIL )
        this:gobject:=gtk.check_button.new()
    else
        this:gobject:=gtk.check_button.new_with_mnemonic(label)
        if( use_stock!=NIL )
