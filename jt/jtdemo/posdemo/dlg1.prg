...
local dlg:=jtdialogNew(10,10,17,57)
    dlg:caption:="Dialog Demo 1" 
    dlg:layout:="vbox"
    dlg:add( panel("Próba"          , "@R! 99999999-NNNNNNNN-99999999"))
    dlg:add( panel("Próba szere"    , "@R! 99999999-NNNNNNNN-99999999"))
    dlg:add( panel("Próba szerencse", "@R! 99999999-NNNNNNNN-99999999"))
    dlg:add( panel("Próba szere"    , "@R! 99999999-NNNNNNNN-99999999"))
    return dlg
