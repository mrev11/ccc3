...
******************************************************************************
class columndef(sql2.mysql.columnref) 
    method  initialize
...
static function columndef.initialize(this,name,expr,type)
    this:(sql2.mysql.columnref)initialize(name,expr)  
    this:type:=type
...
local type,prec
    ...
    elseif( type=="L" )
        type:="boolean"       //MySQL-ben boolean egy alias tinyint-re
