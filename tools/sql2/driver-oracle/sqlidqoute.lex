...
%option c++
%option yyclass="_nsp_sql2::_nsp_oracle::sqlidquote_lexer"
%option noyywrap
%option stack
%option prefix="_sql2_oracle_sqlidquote"
...
{symbol}        {cat('\"');cat_upper();cat('\"');} /*idézőjelek közé teszi*/
{quoted}        {cat_upper();} /*már idézőjelezve van*/
{string}        {cat();} /*kikerül*/
\n              {}
.               {cat();}
