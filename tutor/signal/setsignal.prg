 ...
 */
...
#ifdef EMLEKEZTETO
  Elindítjuk a programot, majd CTRL-C-t nyomogatunk neki.
  Amikor a program a számlálót írja ki, xx értéke mindig '??'.
  Amikor a program a CTRL-C-t kapja, xx értéke mindig '!!'.
  Ez demonstrálja, hogy a 'set signal block/unblock' utasítás
  védi a közrefogott kódot a szignáloktól.
  ...
  éppen ezt teszi a 'set signal block/unblock' utasítás.
#endif
