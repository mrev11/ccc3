//input: ppo/compile_tds.ppo (5.7.2)

#include <cccdef.h>

extern void _clp_compile_tds(int argno);
...
//=======================================================================
void _clp_compile_tds(int argno)
{
VALUE *base=stack-argno;
stack=base+min(argno,2);
while(stack<base+4)PUSHNIL();
argno=2;
push_call("compile_tds",base);
//
    line(9);
    line(10);
    line(13);
